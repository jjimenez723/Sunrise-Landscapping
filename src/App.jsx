...
const projectImage = (id) => `/images/${id}_2x_natural.jpg`;

const images = {
  hero: projectImage("4441b396-975e-5178-b423-1ab32ac6ee0c"),
  about: projectImage("7bad1ee7-15a7-5b4e-b536-da3dbf280871"),
  patio: projectImage("8f59c1d1-48e6-589c-96bb-5cbdc5e41417"),
  lawn: projectImage("fe2d2a32-6c7f-5ea4-87f7-f06c0b483f56"),
  design: projectImage("13e03917-2f99-576e-8d14-84c455f32d47"),
  walls: projectImage("13b7d618-140b-542b-b5b2-b964a0dda8f7"),
  planting: projectImage("48efcb19-f9fc-5269-a233-92d55ac395a1"),
  cleanup: projectImage("5c066179-ac2b-5c64-81ef-d3c65d8d5269"),
};
...
const portfolio = [
  { title: "Retaining wall & garden steps", image: projectImage("4441b396-975e-5178-b423-1ab32ac6ee0c") },
  { title: "Paver landing", image: projectImage("8f59c1d1-48e6-589c-96bb-5cbdc5e41417") },
  { title: "Healthy lawn care", image: projectImage("fe2d2a32-6c7f-5ea4-87f7-f06c0b483f56") },
  { title: "Front garden refresh", image: projectImage("48efcb19-f9fc-5269-a233-92d55ac395a1") },
  { title: "Layered planting bed", image: projectImage("9a53f946-690a-5cf4-a4f2-55607f01dd4a") },
  { title: "Paver walkway install", image: projectImage("7a5cce70-8a1f-526f-b2e7-c2024042a048") },
  { title: "Garden wall & steps", image: projectImage("13b7d618-140b-542b-b5b2-b964a0dda8f7") },
  { title: "Seasonal cleanup", image: projectImage("5c066179-ac2b-5c64-81ef-d3c65d8d5269") },
  { title: "Commercial evergreen install", image: projectImage("1989f163-c6ec-51c4-a117-b580532767e0") },
  { title: "Landscape bed in bloom", image: projectImage("13e03917-2f99-576e-8d14-84c455f32d47") },
  { title: "Backyard patio build", image: projectImage("6a819328-a407-5b84-b684-cccb542a0c4b") },
  { title: "Tree, shrub & mulch refresh", image: projectImage("7bad1ee7-15a7-5b4e-b536-da3dbf280871") },
];
...
function App() {
  ...
  return (
    <>
      <div className="utility-bar"><div className="shell utility-inner"><span>Serving North Plainfield & Central New Jersey · {storeHours}</span><a href={phoneHref}>{phone}</a></div></div>
      ...
      <main>
        <section className="hero" id="top">
          ...
          <div className="hero__image-wrap"><img className="hero__image" src={images.hero} alt="Finished retaining walls, garden beds, and paver steps" fetchPriority="high" /><div className="hero__image-caption"><span>Crafting the places<br />you come home to.</span><span>01 / {String(portfolio.length).padStart(2, "0")}</span></div></div>
        </section>
